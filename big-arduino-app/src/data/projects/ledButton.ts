...
export const ledButtonProject: Project = {
  ...
  steps: [
    ...
    },
    {
      ...
      description: 'Now insert the 220\u03A9 resistor into the breadboard. The resistor helps protect your LED from too much current. Without a resistor, the LED could be damaged.',
      instructions: [
