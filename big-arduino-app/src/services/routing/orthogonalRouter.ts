...
function orthogonalConnect(a: Point, b: Point): Point[] {
  ...
  // Vertical first: corner at (a.x, b.y) — first leg moves up/down toward the target, then across.
  // Stable choice vs H-then-V and matches “drag down → bend opens downward, drag up → bend opens upward”.
