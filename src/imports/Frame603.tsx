import svgPaths from "./svg-w9mn2nrpvl";
...
function Frame8() {
  return (
    <div className="bg-[#fff7d6] content-stretch flex items-center justify-center px-[16px] py-[8px] relative rounded-[10px] shrink-0">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] not-italic relative shrink-0 text-[#444] text-[14px] tracking-[0.28px]">
        <span className="leading-[20px] text-[#1a2bc3]">1</span>
        <span className="leading-[20px] text-[#7c7b7b]">/6</span>
      </p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[20px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Frame 547">
          <rect fill="var(--fill-0, #FCC049)" height="20" rx="10" width="20" />
          <path d={svgPaths.p295a4200} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Frame5() {
  return (
    <div className="bg-[#f4f5f6] content-stretch flex items-center justify-center px-[16px] py-[14px] relative rounded-[10px] shrink-0">
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[14px] text-black tracking-[0.28px] w-[236px] whitespace-pre-wrap">
        <p className="mb-0">Pick out components from the panel to add to your workplace.</p>
        <p className="mb-0">&nbsp;</p>
        <p className="text-[#1a2bc3]">Encourage sentences</p>
      </div>
    </div>
  );
}
