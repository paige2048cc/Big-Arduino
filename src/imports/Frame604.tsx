import svgPaths from "./svg-htg2biepwq";
...
function Frame8() {
  return (
    <div className="bg-[#fff7d6] content-stretch flex items-center justify-center px-[16px] py-[8px] relative rounded-[10px] shrink-0">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] not-italic relative shrink-0 text-[#7c7b7b] text-[14px] tracking-[0.28px]">
...
function Frame1() {
  return (
    <div className="bg-[#fff7d6] content-stretch flex flex-col items-center justify-center px-[6px] relative rounded-[10px] shrink-0 size-[20px]">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[14px] text-black tracking-[0.28px]">2</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="bg-[#f4f5f6] content-stretch flex items-center justify-center px-[16px] py-[14px] relative rounded-[10px] shrink-0">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[14px] text-black tracking-[0.28px] w-[236px] whitespace-pre-wrap">{`Create wires connecting Arduino's 5V pin with the red (+) power rail on your breadboard, and likewise GND with the black (-) ground rail.`}</p>
    </div>
  );
}
